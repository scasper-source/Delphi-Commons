...
- Attach screenshot/log artifacts from the 2026-05-29 clean Windows `r8` retest, then merge, package, and rerun the Study Workspace Launcher, saved-study reopen/new-study continuity, and governance signoff paths recorded in [WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md](./WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md).
