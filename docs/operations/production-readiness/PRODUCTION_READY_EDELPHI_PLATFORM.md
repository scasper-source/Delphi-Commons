...
macOS Apple Silicon local source-built portable smoke evidence: [MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md](./MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md).
...
- macOS laptop operator path: **included, evidence-dependent**; one 2026-05-14 Apple Silicon post-fix lifecycle rerun and one 2026-05-31 local source-built Apple Silicon portable smoke are recorded, but broad macOS support/readiness is not claimed.
...
- Triage the 2026-05-31 macOS local smoke follow-up findings before a new macOS package is treated as ready for clean release-asset testing: `brace-expansion` lockfile update, deployment security verifier npm ENOENT handling, build staging cleanup, reset-snapshot pruning, and `macos-portable.mjs` maintainability.
...
- macOS source-built portable lifecycle smoke evidence for commit `2a831ee` is recorded in [MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md](./MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md), with follow-up findings still open.
...
- 2026-05-31 local source-built portable smoke status: macOS arm64 lifecycle smoke at commit `2a831ee` passed app/server install/build/test, package build, start, browser UI load, smoke, restart, stop, reset, and final port-clear checks. Evidence: [MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md](./MACOS_OPERATOR_PORTABLE_LOCAL_SMOKE_EVIDENCE_2026-05-31.md). This does not replace clean release-asset testing. Open follow-up findings remain for dependency audit posture, deployment security verifier npm resolution, build staging cleanup, reset-snapshot pruning, and packaging-script readability.
