...
- Capture install/start/status/browser-open/stop/uninstall evidence from the downloaded Windows installer ZIP bundle on a clean Windows profile or second Windows machine.
