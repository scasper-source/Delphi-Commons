...
- Capture install/start/browser-open/browser-window-close-to-stop/uninstall evidence from the downloaded Windows installer ZIP bundle on a clean Windows profile or second Windows machine, using the 15-step retest checklist in [WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md](./WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md).
...
- Current merged status: installer packaging logic is implemented, real-Mac `.pkg` build/package-verification evidence is recorded, and corrected release `internal-macos-package-candidate-2026-05-18-r4` has downloaded-asset inspection evidence. Install and installed-path human lifecycle remain **BLOCKED / NOT RUN** until an operator-authorized macOS install is performed.
