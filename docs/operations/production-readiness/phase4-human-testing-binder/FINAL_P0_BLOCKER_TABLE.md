...
| F4-P0-009 | Governance owner + Study Owner/operator | OPEN / CODE_FIX_PENDING_PACKAGE_RETEST | `../WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md`, `SCREENSHOT_LOG_EVIDENCE_INDEX.md`, `server/tests/signoffGovernanceFlow.test.mjs`, `app/tests/policyGates.test.mjs` | 2026-05-29 clean Windows `r8` report indicates Study Owner/PI and Ethics & Methods/PI signoff controls appear broken, unreachable, or not wired clearly enough for the operator workflow. 2026-05-31 local code follow-up verifies package-mode backend signoff role/sequence boundaries and clarifies UI labels, assignment guidance, and disabled-action reasons. | Merge the code fix, rebuild/release a corrected package, and retest governance signoff from the packaged app before any human-use readiness mark. |
