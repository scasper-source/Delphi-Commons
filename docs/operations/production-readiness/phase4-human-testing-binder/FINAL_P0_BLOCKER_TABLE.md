...
| F4-P0-002 | Study Owner/operator | OPEN | `OPERATOR_CHECKLIST.md` | Clean laptop profile or second-machine operator launch evidence is missing. | Run documented operator launch from clean profile and attach logs/screenshots. |
