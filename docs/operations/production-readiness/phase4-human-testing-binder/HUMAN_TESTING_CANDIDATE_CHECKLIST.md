...
| Windows auth/session save-reopen proof | Installed-package Study Builder save/list/reopen continuity evidence attached | FAIL / OPEN | `../WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md` | 2026-05-29 report: create/save/list passed, but reopen/new-study continuity failed or was unclear; close only after fixed rerun evidence for steps 8/9/10 and post-relaunch smoke |
