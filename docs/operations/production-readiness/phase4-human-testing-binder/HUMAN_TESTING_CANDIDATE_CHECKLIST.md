...
| Windows auth/session save-reopen proof | Installed-package Study Workspace Launcher and Study Builder save/list/reopen continuity evidence attached | OPEN / CODE_FIX_PENDING_PACKAGE_RETEST | `../WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md`, `../../../../server/tests/multipleStudyPersistence.test.mjs`, `../../../../app/tests/policyGates.test.mjs` | 2026-05-29 report: create/save/list passed, but reopen/new-study continuity failed or was unclear. 2026-05-31 local follow-up adds the Study Workspace Launcher and multi-study persistence coverage; close only after corrected package rerun evidence for launcher path, steps 8/9/10, and post-relaunch smoke |
| Governance signoff controls | Study PI and Ethics PI signoff can be reached and recorded from packaged operator flow | OPEN / CODE_FIX_PENDING_PACKAGE_RETEST | `FINAL_P0_BLOCKER_TABLE.md`, `../WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md`, `../../../../server/tests/signoffGovernanceFlow.test.mjs`, `../../../../app/tests/policyGates.test.mjs` | 2026-05-29 report: signoff controls appeared broken, unreachable, or not wired clearly enough. 2026-05-31 local follow-up verifies backend sequencing and clarifies UI, but this row remains open until corrected package retest evidence exists. |
