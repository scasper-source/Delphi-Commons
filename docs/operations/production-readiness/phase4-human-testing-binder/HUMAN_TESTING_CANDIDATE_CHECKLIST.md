...
| Governance signoff controls | Study Owner and Ethics & Methods signoff can be reached and recorded from packaged operator flow | FAIL / OPEN | `FINAL_P0_BLOCKER_TABLE.md`, `../WINDOWS_GITHUB_INSTALLER_RELEASE_ASSET_EVIDENCE_2026-05-21.md` | 2026-05-29 report: signoff controls appeared broken, unreachable, or not wired clearly enough |
