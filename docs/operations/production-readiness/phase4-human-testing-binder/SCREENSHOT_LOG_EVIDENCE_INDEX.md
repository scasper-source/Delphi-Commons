...
| F4-EVID-005 | Screenshot | Synthetic study setup | PARTIAL_REPORTED | HUMAN_REQUIRED | 2026-05-29 operator report says synthetic study create/save and dashboard list passed, but reopen/new-study continuity failed or was unclear. Corrected-package retest must cover the Study Workspace Launcher path. |
...
| F4-EVID-020 | Screenshot/log | Study Workspace Launcher, saved-study reopen, and post-relaunch continuity | CODE_FIX_PENDING_RETEST | HUMAN_REQUIRED | 2026-05-29 operator report says saved-study reopen was not proven and post-relaunch smoke/new-study continuity failed or was unclear. 2026-05-31 local code follow-up adds launcher and multi-study persistence coverage; corrected-package screenshots/logs are still required. |
