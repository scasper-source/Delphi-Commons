...
| F4-EVID-005 | Screenshot | Synthetic study setup | PARTIAL_REPORTED | HUMAN_REQUIRED | 2026-05-29 operator report says synthetic study create/save and dashboard list passed, but reopen/new-study continuity failed or was unclear. Corrected `r9` package retest must cover the Study Workspace Launcher path. |
...
| F4-EVID-020 | Screenshot/log | Study Workspace Launcher, saved-study reopen, and post-relaunch continuity | CORRECTED_PACKAGE_RELEASED_PENDING_RETEST | HUMAN_REQUIRED | Corrected `r9` package exists with launcher and multi-study persistence coverage; clean Windows screenshots/logs are still required. |
| F4-EVID-021 | Screenshot/log | Study PI and Ethics PI signoff controls | CORRECTED_PACKAGE_RELEASED_PENDING_RETEST | HUMAN_REQUIRED | Corrected `r9` package exists with backend regression and clearer UI; clean Windows screenshots/logs are still required. |
